...
use App\Http\Requests\BrandingSettingsRequest;
use App\Http\Requests\OjtSettingsRequest;
use App\Http\Requests\TenantProfilePasswordRequest;
...
class TenantProfileController extends Controller
{
    ...
    public function update(TenantProfileRequest $request, CurrentTenant $currentTenant): RedirectResponse
    {
    ...
    public function updatePassword(TenantProfilePasswordRequest $request, CurrentTenant $currentTenant): RedirectResponse
    {
    ...
    public function saveOjtSettings(OjtSettingsRequest $request, CurrentTenant $currentTenant): RedirectResponse
    {
        $tenant = $currentTenant->tenant();
