...
use App\Http\Requests\ResetTenantPasswordRequest;
use App\Http\Requests\SendTenantPasswordResetCodeRequest;
...
class TenantForgotPasswordController extends Controller
{
    ...
    public function store(SendTenantPasswordResetCodeRequest $request, CurrentTenant $currentTenant, ?string $role = null): RedirectResponse
    {
        $tenant = $currentTenant->tenant();
    ...
    public function update(ResetTenantPasswordRequest $request, CurrentTenant $currentTenant, ?string $role = null): RedirectResponse
    {
        $tenant = $currentTenant->tenant();
